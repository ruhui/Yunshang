package com.shidai.yunshang.receives;
...
import com.shidai.yunshang.activities.JupshReceiveActivity_;
	...
	public void onReceive(Context context, Intent intent) {
		try {
			...
			if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
				...
				//打开自定义的Activity
				Intent i = new Intent(context, JupshReceiveActivity_.class);
				i.putExtras(bundle);
				//i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
				context.startActivity(i);

//				EventBus.getDefault().post(new JupshReceiveListener(bundle));
